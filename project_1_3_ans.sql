...
select * from film;
-- one with bug:
select distinct rental_date from rental where rental_date between '2005-05-01' and '2005-05-31';
-- better solutions:
select distinct rental_date from rental where substring(rental_date,1,7) between '2005-05' and '2005-05';
select distinct rental_date from rental where rental_date between '2005-05-01 00:00:00' and '2005-05-31 23:59:59';
...
-- 3.6
-- In question 3.5 I used inventory as a base table which actually can not identify the film which is out of stock
